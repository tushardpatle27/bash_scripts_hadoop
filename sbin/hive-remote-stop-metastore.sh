...
for server in ${hive_server_ip_final[@]}
do
        stop_hive "$server" "$hive_server_username_final" "$hive_server_acc_typ_final" "$hive_server_acc_tkn_final"
done
echo "Hivestopping - $(tput setaf 2)Done$(tput sgr0)"
