...
export ZOOKEEPER_HOME="${INSTALL_DIRECTORY}/tdss/zookeeper"
#export JAVA_HOME=$(readlink -f /usr/bin/java | sed "s:/bin/java::")
export JAVA_HOME=$(readlink -f "${INSTALL_DIRECTORY}/tdss/java" | sed "s:/bin/java::")
export HADOOP_HOME="${INSTALL_DIRECTORY}/tdss/hadoop"
export HADOOP_CONF_DIR=$HADOOP_HOME/etc/hadoop
export HADOOP_LOG_DIR=$HADOOP_HOME/logs
export HADOOP_MAPRED_DIR=$HADOOP_HOME
